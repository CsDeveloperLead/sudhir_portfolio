  ...
  return (
    <div className='w-full h-auto flex flex-col px-5 my-10 md:flex-row-reverse md:justify-between  lg:mb-20 md:px-10 xl:px-20'>
        ...
        <div className='w-full h-auto flex flex-col font-satoshi mt-7 sm:w-[70%] mx-auto md:w-[50%] md:mx-0'>
            ...
            <p className='my-8 lg:text-lg lg:my-12'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto voluptate nemo eligendi molestias modi necessitatibus impedit sit ipsa ea consequuntur.</p>
            <Link to='' className='w-32 text-center rounded-2xl font-satoshi text-white bg-[#3071AA] py-2 md:hover:bg-[#428ac9] xl:py-3 xl:w-36'>Read More</Link>
        </div>
    </div> 
  )
}
